...
Процедура Ожидания(Команда)
	//@skip-warning
	Результат = пс_СкриптыКлиент.ПолучитьАктивныеОбработчикиОжиданияВнутр(Элементы.ХТМЛ);
КонецПроцедуры

&НаКлиенте
Процедура Повторения(Команда)
	//@skip-warning
	Результат = пс_СкриптыКлиент.ПолучитьАктивныеОбработчикиПовторенияВнутр(Элементы.ХТМЛ);
КонецПроцедуры

&НаКлиенте
Процедура Подписки(Команда)
	//@skip-warning
	Результат = пс_СкриптыКлиент.ПолучитьАктивныеПодпискиНаСобытияВнутр(Элементы.ХТМЛ);
КонецПроцедуры
