...
Процедура Ожидания(Команда)
	//@skip-warning
	Результат = пс_СкриптыКлиент.ПолучитьАктивныеОбработчикиОжиданияВнутр();
КонецПроцедуры

&НаКлиенте
Процедура Повторения(Команда)
	//@skip-warning
	Результат = пс_СкриптыКлиент.ПолучитьАктивныеОбработчикиПовторенияВнутр();
КонецПроцедуры

&НаКлиенте
Процедура Подписки(Команда)
	//@skip-warning
	Результат = пс_СкриптыКлиент.ПолучитьАктивныеПодпискиНаСобытияВнутр();
КонецПроцедуры
...
Процедура ТестОжиданияОповещения(Команда)
	пс_СкриптыКлиент.ДобавитьОбработчикСобытия(Элементы.ХТМЛ.Документ.body,"click", Новый ОписаниеОповещения("тестСообщитьАдресКлика", ЭтаФорма))
КонецПроцедуры
