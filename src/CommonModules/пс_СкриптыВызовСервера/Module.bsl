...
Процедура ПоместитьВСерверныйКэш(Ключ, Значение) Экспорт
	УстановитьПривилегированныйРежим(Истина);
	ХранилищеОбщихНастроек.Сохранить(Ключ,,Значение);	
КонецПроцедуры

Функция ПолучитьИзСерверногоКэша(Ключ) Экспорт
	УстановитьПривилегированныйРежим(Истина);
...
Функция АдресОсновногоРасширенияСкриптов() Экспорт
	Возврат пс_СкриптыСерверПовтИсп.АдресОсновногоРасширенияСкриптов();
КонецФункции

Функция НавигационнаяойСсылкаВременногоХранилища(АдресВременногоХранилища) Экспорт
	СсылкаБазы = ПолучитьНавигационнуюСсылкуИнформационнойБазы();
	ПрефиксАдреса = КодироватьСтроку(СсылкаБазы, СпособКодированияСтроки.URLВКодировкеURL) + "/";
	Возврат ПрефиксАдреса + АдресВременногоХранилища; 	
КонецФункции
